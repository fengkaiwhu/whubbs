<?php
define("USERFACE_IMG_NUMS",330);
define("USERFACE_IMG_CUSTOM",-1);
define("USERFACE_IMG_URL",-2);
if (!defined('_BBS_USERDATA_FUNCS_PHP_'))
{
define('_BBS_USERDATA_FUNCS_PHP_', 1);
function getgroups()
{
	$groups = array();
