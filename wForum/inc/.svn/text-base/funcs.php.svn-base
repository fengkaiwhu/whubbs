...
$Copyright=
"<a href=\"mailto:bbs@whu.edu.cn\" target=\"_blank\">武汉大学BBS&nbsp;珞珈山水站</a>  "
. " All rights reserved. <br/>"
. "<a href=\"/wForum/index.php\" target=\"_self\">"
...
<tr>
<td align="left" width="10%"><a href="../wmainpage.php"><img border="0" src='<?php echo  $Banner; ?>'/></a></td>
<td align="center" width="80%">
<?php echo MAINTITLE; ?>
</td>
<td align="right" style="line-height: 15pt" width="10%">
<nobr><a href="mailto:bbs@whu.edu.cn">联系我们</a></nobr><br/>
...
<tr><td><nobr>
<img src="pic/forum_nav.gif" align="absmiddle"/> <a href="../wmainpage.php"><?php   echo $SiteName; ?></a> → 
<?php 
	if ($Title!='') {
