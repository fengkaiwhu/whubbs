...
function preprocess(){
	...
	$reArticles=$articles;
	global $currentuser;//davidxn added before double eleven of 2012
	if( $boardName=="single" && !($currentuser["userlevel"]&BBS_PERM_SYSOP )  ){
	foundErr("You don't have the right to delete this article.Please contact the system manager!");
	}
