...
function preprocess(){
    ...
    foundErr("guest用户暂无权限阅读一年前的帖子，您可以登录后再阅读");
    }}
...
<?php
 include("inc/annu_Selection.php");  //bbs年度评选 by kfeng 2015-2-2
 ...
 if($article['OWNER'] == 'zhu'){
	$select = "&nbsp;&nbsp;<font color='red'><b>" . '2014年度优秀水手' . "</b></font> <br/>";
	echo "<nobr>".$select."</nobr>";
 }
?>
...
&nbsp;&nbsp;门派：<?php echo $groupinf[1]; ?>&nbsp<?php echo $groupinf[2]; ?><br/><?php }?>
&nbsp;&nbsp;身份：<?php 
...
?><br/>
&nbsp;&nbsp;等级：<?php echo bbs_getexplevel($article['OWNER']); ?><br/>
...
<?php
//added by davidxn  2013.11.28 校庆抢楼
