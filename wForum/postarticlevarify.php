...
<BR><BR></td>
	...
	<?php
		...
		if(!isset($_SESSION['firstpostarticle'])) {
	...
	<input type=Submit value='发 表' name=Submit id="oSubmit" disabled = true> &nbsp;&nbsp;&nbsp; <input type=button value='预 览' name=preview onclick=gopreview()>
                </td></form></tr>
      </table>
</form>
...
if(isset($_SESSION['firstpostarticle'])) {
	echo "<script type=\"text/javascript\">document.getElementById(\"oSubmit\").disabled = false;</script>";
}
?>
