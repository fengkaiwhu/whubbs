	...
	<tr>
		<td>
			<table height=100% width=150>
				...
				<tr><td height=88 valign=middle align="center"><a href=javascript:void(0) onclick=copy_url()>邀请好友！</a><br>[<a href=index.php>退出</a>]<script>if(site == "host") document.write("[<a href=end.php?roomid=<?php echo $_GET[id];?>>结束</a>]");</script></td></tr>
