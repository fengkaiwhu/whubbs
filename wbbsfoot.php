...
<meta http-equiv="refresh" content="120;url=wbbsfoot.php">
<body><div class="footer">时间[<span id="divTime"></span>] 在线[<?php echo bbs_getonlinenumber(); ?>]
帐号[<a href="wForum/dispuser.php?id=<?php echo $currentuser["userid"]; ?>" target="main"><?php echo $currentuser["userid"]; ?></a>]
<?php
	if (isset($total)) {
echo "信箱[<a href=\"wForum/usermailbox.php?boxname=inbox\" target=\"main\">";
		if ($unread) {
