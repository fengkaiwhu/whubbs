...
<div class="main">
  <div class="header">
    ...
    <p>名称：<input name="user" type="text" size="21" /></p>
    <p>密码：<input name="password" type="password" value="talk" size="23" /><input style="visibility:hidden;" name="type" value="talk" type="checkbox" checked=true/></p>
