...
<form action="upsave.php?action=upfile" method="post" name="UForm" enctype="multipart/form-data"> 
  <div id="ua">请选择文件： </div>
  <div id="ub">
	 <input type="file" name="photo" style="margin-right:2px;"><input type="submit" value="上传">
