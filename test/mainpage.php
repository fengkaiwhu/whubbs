...
?>
  <tr>
    <td class="HotTitle">[<a href="bbsdoc.php?board=<?php echo $brd_encode; ?>">
      <?php  echo htmlspecialchars($brdarr["DESC"]); ?>
      </a>]<a href="bbstcon.php?board=<?php echo $brd_encode; ?>&gid=<?php echo $hot_groupid; ?>"><?php echo htmlspecialchars($hot_title); ?></a></td>
    <td class="HotAuthor"><a href="bbsqry.php?userid=<?php echo $hot_author; ?>">
      <?php  echo $hot_author; ?>
      </a>&nbsp;&nbsp;</td>       
  </tr>
  <?php
    ...
    <td width="100%" class="MainContentText"><ul style="margin: 5px 0px 0px 15px; padding: 0px;">
        <?php
					...
					if($articles[$i]['origin']['FLAGS'][0]=='g'){
						if($j--<0) break;
?>
        <li class="default"><?php echo "<a href=\"bbstcon.php?board=".$brdarr['NAME']."&amp;gid=".$articles[$i]['origin']['ID']."\">" .htmlspecialchars($articles[$i]['origin']['TITLE'],ENT_QUOTES) . "</a>"; ?></li>
        <?php			}
					}
				}
			}
...
?>
<tr>
  <td class="SectionItem">[<a href="bbsdoc.php?board=<?php echo $brd_encode; ?>">
    <?php  echo htmlspecialchars($brdarr["DESC"]); ?>
    </a>]<a href="bbstcon.php?board=<?php echo $brd_encode; ?>&gid=<?php echo $hot_groupid; ?>"><?php echo htmlspecialchars($hot_title); ?></a>&nbsp;&nbsp;</td>
    <td class="HotSecAuthor"><a href="bbsqry.php?userid=<?php  echo $hot_author; ?>"><?php  echo $hot_author; ?></a></td>
</tr>
<?php
	}
}
...
?>
  <tr>
    <td colspan="2" valign="top" class="SectionTitle"><script type="text/javascript">putImage("section.gif","");</script>
      &nbsp;<span class="SectionName"><a href="bbsboa.php?group=<?php echo $t[$i]; ?>"><?php echo htmlspecialchars(constant("BBS_SECNAME".$t[$i]."_0")); ?></a></span>&nbsp;&nbsp;<span class="SectionList">
      <?php
...
?>
      <a href="rssi.php?h=2&s=<?php echo $t[$i]; ?>" target="_blank">[RSS]</a><a href="bbsboa.php?group=<?php echo $t[$i]; ?>">[更多]</a></span></td>
  </tr>
  <?php
...
?>
  <tr>
    <td class="RecommendTitle"><script type="text/javascript">putImage("recommend.gif","");</script>
      &nbsp;<a href="bbsrecon.php?id=<?php echo $commend_id;?>"><?php echo htmlspecialchars($commend_title);?></a></td>
    <td class="RecommendLink"><div align="right">[<a href="bbsdoc.php?board=<?php echo $brd_encode;?>"><?php echo htmlspecialchars($brdarr["DESC"]);?></a>] [<a href="bbstcon.php?board=<?php echo $brd_encode;?>&gid=<?php echo $commend_o_groupid;?>">同主题阅读原文</a>]</div></td>
  </tr>
  <tr>
...
?>
  <tr>
    <td width="100%" height=15 align="right" colspan=2><a href="bbsrecommend.php">更多推荐文章</a></td>
  </tr>
</table>
<?php
}
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    <td valign="top">
	<center>
		<!--<div style="text-align:center"><a href='/ad/09ad.jpg' target=_blank><img width='468' height='60' src='ad/Banner46860final.gif'></a>-->
