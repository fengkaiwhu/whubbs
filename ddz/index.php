...
<table class="box" align=center><tr><td width="218">
	...
	<td width="137"><input class=box_input type=password name=password size=12 maxlenth=25></td></tr>
	<tr><td></td><td><input class=box_submit type=submit name=submit value=登陆></td></tr>
	</table>
</td></tr></table>
</form>
</body>
