<?php /* Smarty version Smarty-3.1.18, created on 2014-12-21 09:51:14
         compiled from ".\templates\modifyuserdata.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54950e3bd9e406_88262946',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54950e3bd9e406_88262946')) {function content_54950e3bd9e406_88262946($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config("test.conf", $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars("setup", 'local'); ?>
...
<form action="saveuserdata.php" method=POST name="theForm">
	...
	<TR> 
	<TD width=40%<?php ?>><B>Email</B>：<BR>您的有效电子邮件地址</TD>
	<TD width=60% > 
	...
	<tr>
	<td valign=top width=40%<?php ?>> 　<b>真实姓名：</b>
	...
	<tr>
		...
		<tr>
			<td valign=top width=40%<?php ?>>　<b>国　　家：</b>
			<b>
	...
	<tr>
		<td valign=top width=40%<?php ?>>　<b>联系电话：</b>
		<b>
	...
	<tr>
		<td valign=top width=40%<?php ?>>　<b>通信地址：</b>
		<b>
	...
	<tr>
		<td valign=top width=40%<?php ?>>　<b>生　　肖：
		</b>
	...
	<tr>
		<td valign=top width=40%<?php ?>>　<b>职　　业： </b>
	...
	<tr>
	<td valign=top width=40%<?php ?>>　<b>最高学历：</b>
